...
public class Juego { /*defino el tamaño del oceano */
    ...
    public Juego() { /*Constructor del juego. Llama al método `inicializarMapa() para crear el océano con el pez, obstáculos y comida. */
       inicializarMapa();
    } 
    ...
    public void iniciar() {
     ...
     -Si el pez llega a la comida ('C'), el juego termina. */
        ...
        while (true) {/*Muestra el estado actual del océano */
            mostrarMapa();
            System.out.println("Mueve el pez globo con W (arriba), A (izquierda), S (abajo), D (derecha): ");
        ...
        scanner.close();/*Cerrar el Scanner al final del juego */
    }
